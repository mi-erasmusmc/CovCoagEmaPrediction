...
#
# This file is part of CovCoagEmaPrediction
#
...
OhdsiRTools::checkUsagePackage("CovCoagEmaPrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CovCoagEmaPrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CovCoagEmaPrediction.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "CovCoagEmaPrediction")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CovCoagEmaPrediction")
